...
<html lang="en" data-theme="light">
  <head>
    ...
    <meta
      name="description"
      content="This is a stock photos app made by wale"
    />
  ...
  <body>
    ...
    <nav class="navigation" data-navigation>
      ...
      <ul class="drawer-list">
        ...
        <li class="drawer-item">
          <a class='drawer-link' data-drawer-link href='/pages/photos/photos'>
            <span
              class="material-symbols-outlined leading-icon"
              aria-hidden="true"
              >image</span
        ...
        <li class="drawer-item">
          <a class='drawer-link' data-drawer-link href='/pages/videos/videos'>
            <span
              class="material-symbols-outlined leading-icon"
              aria-hidden="true"
              >videocam</span
        ...
        <li class="drawer-item">
          <a class='drawer-link' data-drawer-link href='/pages/collections/collection'>
            <span
              class="material-symbols-outlined leading-icon"
              aria-hidden="true"
        ...
        <li class="drawer-item">
          <a class='drawer-link' data-drawer-link href='/pages/favorite/favorite'>
            <span
              class="material-symbols-outlined leading-icon"
              aria-hidden="true"
              >favorite</span
      ...
      <article>
        ...
        <section class="banner" aria-label="Banner">
          <div class="banner-card primary">
            <div class="card-content">
              ...
              <a class='btn btn-primary' data-ripple href='/pages/photos/photos'>
          ...
          <div class="banner-card secondary">
            <div class="card-content">
              ...
              <a class='btn btn-secondary' data-ripple href='/pages/videos/videos'>
                <span class="label-large text">Explore Now</span>
          ...
          <div class="banner-card tertiary">
            <div class="card-content">
              ...
              <a class='btn btn-tertiary' data-ripple href='/pages/collections/collection'>
                <span class="label-large text">Explore Now</span>
        ...
        >
          <div class="container">
            ...
            <div class="media-grid" data-video-grid>
              <div class="card video grid-item"></div>
            </div>

            <div class="overlay-btn">
              <a class='btn btn-primary' data-ripple href='/pages/videos/videos'>
                <span class="label-large text">Explore more</span>
        ...
        <section class="section collection" aria-labelledby="collection-label">
          <div class="container">
            ...
            <a class='btn btn-primary' data-ripple href='/pages/collections/collection'>
        ...
        <div class="footer-card">
          <div class="col">
            ...
            <p class="text body-small">
              ...
              <a
                href="https://taiwo-adewale.vercel.app/"
                target="_blank"
                class="color-primary"
                >Wale</a
              >
